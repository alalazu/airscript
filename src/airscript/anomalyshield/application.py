...
TYPENAME = 'anomaly-shield-application'
KIND = 'AnomalyShieldApplication'

lookup.registerBoth( element.LOOKUP_TYPENAME, element.LOOKUP_KIND, TYPENAME, KIND )

class AnomalyShieldApplication( element.ModelElement ):
    def __init__( self, parent, obj=None, id=None ):
        self._typename = TYPENAME
        self._path = 'anomaly-shield-applications'
        self._kind = KIND
